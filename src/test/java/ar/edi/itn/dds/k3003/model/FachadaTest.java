...
public class FachadaTest {
  ...
  void agregarTest() {
    ...
    assertEquals(1, repoHeladera.size());

    fachadaHeladera.agregar(heladeraDTOTest2);
    assertEquals(2, repoHeladera.size());
  }
  ...
  void temperaturaTestHeladeraNoExiste(){
    ...
    // Espero que lance una excepcion
    assertThrows(NoSuchElementException.class, () -> fachadaHeladera.temperatura(new TemperaturaDTO(10, heladeraAgregada3.getId() + 1 , tiempo.plusMinutes(5))));
